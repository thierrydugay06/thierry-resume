    ...
    <div className="min-h-screen bg-[#FDFBF9] py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <a href="/Thierry_Dugay_General_Resume.pdf" download className="flex items-center gap-2 bg-[#6B5344] hover:bg-[#8B7355] text-white px-5 py-2 rounded-lg text-sm"><Download size={16} /> Download PDF</a>
        </div>
        ...
        <div className="bg-white p-10 rounded-xl shadow-md">
          ...
          <Section title="PROFILE">
            <p className="text-gray-700 text-sm leading-relaxed">Adaptable and technically-proficient professional with a strong background in automation, AI systems, and technical problem-solving. Built 5+ automation tools reducing manual workflow time by 70% through Python, n8n, and API integrations. Quick learner with a <span className="font-semibold">3.72 GPA</span>, combining analytical insights with technical expertise to optimize complex systems and workflows.</p>
          </Section>
          ...
          <Section title="EDUCATION">
            <div className="mb-3">
              ...
              <p className="text-gray-500 text-sm mt-1">Relevant Coursework: Statistical Analysis, Research Methods, Financial Accounting, Managerial Accounting</p>
            </div>
            <div>
          ...
          <Section title="TECHNICAL SKILLS">
            <ul className="space-y-1 text-sm text-gray-700">
              <li><span className="font-semibold">Automation & AI:</span> n8n, API Integration, workflow automation, automated reporting systems, prompt engineering</li>
              <li><span className="font-semibold">Programming:</span> Python (data analysis, scripting), C++, CLI development, logic and algorithms</li>
              <li><span className="font-semibold">Infrastructure & Systems:</span> NAS setup and administration — built centralized private storage eliminating cloud dependency and reducing data costs; networking, hardware assembly, troubleshooting</li>
              <li><span className="font-semibold">Data & Analysis:</span> Microsoft Excel (advanced), statistical software, data visualization</li>
            </ul>
          </Section>
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>Designed and deployed 5+ automation systems reducing manual processes by ~70% using Python and n8n</li>
                  <li>Built automated reporting and real-time notification systems replacing manual data entry workflows</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>Architected NAS-based system eliminating external cloud reliance, cutting data costs, and enabling secure remote access</li>
                  <li>Optimized network configurations for high-speed transfer across devices</li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside mt-1 space-y-1">
                  <li>Built CLI tools including a financial calculator and secure password generator demonstrating strong algorithmic design</li>
                </ul>
              </div>
              <div>
          ...
          <Section title="CERTIFICATIONS & INTERESTS">
            <p className="text-sm text-gray-700">Currently pursuing certifications in Python programming and technical skills. Strong interest in automation, AI systems, and workflow optimization technologies.</p>
          </Section>
        </div>
      </div>
    </div>
